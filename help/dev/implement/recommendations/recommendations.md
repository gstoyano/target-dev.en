...
To access the **[!UICONTROL Recommendations Settings]** options, open Target in the Adobe Experience Cloud, then click **[!UICONTROL Recommendations]** > **[!UICONTROL Settings]**.
...
| Setting | Description |
|--- |--- |
|Custom Global Mbox|(Optional) Specify the custom global mbox used to serve Target activities. By default, the global mbox used by Target is used for Recommendations.<br />Note: This option is set on the Target **[!UICONTROL Administration]** page. Open Target, then click **[!UICONTROL Administration]** > **[!UICONTROL Visual Experience Composer]**.|
