...
>Or
>
>Manually download at.js 2.*x* using the Target UI and deploy it using the [method of your choice](/help/dev/implement/client-side/atjs/how-to-deployatjs/how-to-deployatjs.md).
